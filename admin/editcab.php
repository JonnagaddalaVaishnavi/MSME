...
if (isset($_GET['delete_product'])) {
    ...
    $delete_product = mysqli_query($con, "DELETE FROM `cabels` WHERE id = '$product_id'") or die(mysqli_error($con));
    if ($delete_product) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_product'])) {
    ...
    $update_product = mysqli_query($con, "UPDATE `cabels` SET name = '$product_name', price = '$product_price', image = '$product_image' WHERE id = '$product_id'") or die(mysqli_error($con));
    if ($update_product) {
...
if (isset($_GET['edit_product'])) {
    ...
    $product_result = mysqli_query($con, "SELECT * FROM `cabels` WHERE id = '$product_id'") or die(mysqli_error($con));
    $product_data = mysqli_fetch_assoc($product_result);
}

// Retrieve all products from the "mobiles" table
$products = mysqli_query($con, "SELECT * FROM `cabels`") or die(mysqli_error($con));
?>
<!DOCTYPE html>
<html lang="en">
<head>
